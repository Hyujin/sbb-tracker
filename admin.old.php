						...
						<?php
							...
							if ($result->num_rows > 0) {
							  ...
							  while($row = $result->fetch_assoc()) {
							       ...
							       echo "<td scope='col'> <input type='text id='cx_phone' size='6' name='cx_phone' class='hidden' value=".$row['cx_phone']." </td>";
							       echo "<td scope='col'> <input type='text' id='disposition' size='15' name='disposition' class='hidden' value=\"" . $row["disposition"] . "\" </td>";
							       echo "<td scope='col'> <input type='text' id='amount' size='4' name='amount' class='hidden' value=".$row['amount']." </td>";
							       echo "<td scope='col'> <input type='text' id='timestamp' size='18' name='timestamp' class='hidden'  value=\"" . $row["timestamp"] . "\" </td>";
